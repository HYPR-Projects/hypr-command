...
app.post('/checklists', async (req, res) => {
  try {
    ...
    const insertParams = {
      ...
      products: f.products || [],
      o2o_impressoes: sanitizeImpressao(f.o2o_impressoes ?? f.O2O_imp),
      o2o_views: sanitizeImpressao(f.o2o_views ?? f.O2O_views),
      has_bonus: f.has_bonus === 'Sim' || f.has_bonus === true,
      bonus_o2o_impressoes: sanitizeImpressao(f.bonus_o2o_impressoes ?? f.O2O_bonus_imp),
      bonus_o2o_views: sanitizeImpressao(f.bonus_o2o_views ?? f.O2O_bonus_views),
...
app.put('/checklists/:id', async (req, res) => {
  try {
    ...
    if (f.o2o_impressoes !== undefined || f.O2O_imp !== undefined) add('o2o_impressoes', sanitizeImpressao(f.o2o_impressoes ?? f.O2O_imp), 'INT64')
    if (f.o2o_views !== undefined || f.O2O_views !== undefined) add('o2o_views', sanitizeImpressao(f.o2o_views ?? f.O2O_views), 'INT64')
    if (f.has_bonus !== undefined) add('has_bonus', toBool(f.has_bonus), 'BOOL')
    if (f.bonus_o2o_impressoes !== undefined || f.O2O_bonus_imp !== undefined) add('bonus_o2o_impressoes', sanitizeImpressao(f.bonus_o2o_impressoes ?? f.O2O_bonus_imp), 'INT64')
    if (f.bonus_o2o_views !== undefined || f.O2O_bonus_views !== undefined) add('bonus_o2o_views', sanitizeImpressao(f.bonus_o2o_views ?? f.O2O_bonus_views), 'INT64')
